...
4. Den Datenbank-Server und einen Nutzer festlegen:
  ...
  ```sql
  SELECT, UPDATE, DELETE, GRANT OPTION, INSERT, ALTER, CREATE, DROP, LOCK TABLES
  ```
  <!--- ` -->
  ...
  ```sql
  SELECT, UPDATE, DELETE, GRANT OPTION, INSERT, ALTER, CREATE,
  DROP, LOCK TABLES, ON *.* TO '$MASTER_DBUSER$'@'$MASTER_DBHOST$'
