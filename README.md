...
Abgaben bewerten  | &nbsp;
----------------- | -----------------
Abgaben lassen sich nach dem Szenario, dem Übungsblatt, <br>der Übungsaufgabe oder nach der User-ID sortieren <br>(oder nach einer Kombination dieser Parameter) | [![][s1t]][s1]
