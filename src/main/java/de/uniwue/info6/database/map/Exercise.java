...
public class Exercise implements java.io.Serializable {
	...
	private Set generatedTags = new HashSet(0);
	...
	public Exercise(ExerciseGroup exerciseGroup, Exercise exercise, String question, String name, Byte credits,
			Date lastModified, Set userEntries, Set userExTags, Set generatedTags, Set exercises, Set solutionQueries) {
	...
	public Set getGeneratedTags() {
		return this.generatedTags;
	}

	@XmlTransient
	public void setGeneratedTags(Set generatedTags) {
		this.generatedTags = generatedTags;
	}
